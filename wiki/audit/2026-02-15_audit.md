...
```
== vizion-onboarding ==
remote=git@github.com:VizionCorpAI/vizion-onboarding.git
branch=main
dirty=1
...
agent_builder,builder,vizion-onboarding,/root/VizionAI/WORKSPACES/vizion-onboarding,git@github.com:VizionCorpAI/vizion-onboarding.git,agent_builder,AIDB,public,agent_,active
...
drwxr-xr-x  3 ubuntu ubuntu 4096 Feb 15 07:16 vizion-onboarding
