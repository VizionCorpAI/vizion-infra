...
| Network Diagnostics | `http://localhost:32769/webhook/lj5OAvcuC97D0yWt/webhook/chat/network-diagnostics` |
| Resource Monitor | `http://localhost:32769/webhook/4SmbwXrZjUykhNri/webhook/chat/resource-monitor` |
